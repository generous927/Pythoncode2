...
ele1 = driver.find('kwdselectid')#叫做webElement对象

ele1.send_keys('python')

ele2 = driver.find('work_position_input')
...
#选择城市
driver.find_element('work_position_click_bottom_save').click()

#点击搜索
driver.find_element('.ush   button').click()

#搜索结果分析
jobs = driver.find_elements('#resultList div[class=el]')
